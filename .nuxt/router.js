...
const _00a11e77 = () => import('../pages/lights/full-service.vue' /* webpackChunkName: "pages/lights/full-service" */).then(m => m.default || m)
const _5ec64a89 = () => import('../pages/lights/consultation.vue' /* webpackChunkName: "pages/lights/consultation" */).then(m => m.default || m)
...
const _1ad919e5 = () => import('../pages/lights/rentals/instructions.vue' /* webpackChunkName: "pages/lights/rentals/instructions" */).then(m => m.default || m)
...
export function createRouter () {
  return new Router({
    ...
    routes: [
		...
		{
			path: "/lights/full-service",
			component: _00a11e77,
			name: "lights-full-service"
		},
		{
			path: "/lights/consultation",
			component: _5ec64a89,
			name: "lights-consultation"
		},
		{
		...
		{
			path: "/lights/rentals/instructions",
			component: _1ad919e5,
			name: "lights-rentals-instructions"
		},
		{
